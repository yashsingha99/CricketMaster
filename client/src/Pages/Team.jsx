    ...
    <div className="conta">
      ...
      <div className="team-cards">
        ...
        <div className="team-card">
          <div className="team-card-header" style={{ backgroundColor: '#ffca37' }}>
        ...
        <div className="team-card">
          <div className="team-card-header" style={{ backgroundColor: '#24449a' }}>
        ...
        <div className="team-card">
          <div className="team-card-header" style={{ backgroundColor: '#121134' }}>
        ...
        <div className="team-card">
          <div className="team-card-header" style={{ backgroundColor: '#240a48' }}>
        ...
        <div className="team-card">
          <div className="team-card-header" style={{ backgroundColor: '#bee9ff' }}>
        ...
        <div className="team-card">
          <div className="team-card-header" style={{ backgroundColor: '#16216c' }}>
        ...
        <div className="team-card">
          <div className="team-card-header" style={{ backgroundColor: '#610505' }}>
        ...
        <div className="team-card">
          <div className="team-card-header" style={{ backgroundColor: '#ee0087' }}>
